...
export class MMDictionary {
  ...
  static initItems() {
    ...
    this.itemInfos = {
      ...
      'Münze': new RuestungInfo(0, 'UNKNOWN', 'RPBKZDNBDW', 10),
      'Quatloo Münze': new RuestungInfo(0, 'UNKNOWN', 'RPBKZDNBDW', 0),
      'Ring': new RuestungInfo(0, 'Ring', 'RPBKZDNBDW', 100),
      'Robe': new RuestungInfo(1, 'Mantel', 'RPBKZDNBDW', 150),
      'Schriftrolle': new RuestungInfo(0, 'UNKNOWN', 'RPBKZDNBDW', 100),
      ...
      'Trank': new RuestungInfo(0, 'UNKNOWN', 'RPBKZDNBDW', 10),
